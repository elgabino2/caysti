          ...
          if (container) {
            ...
            chartRef.current = Highcharts.chart(container, {
              chart: {
                type: 'line',
                zoomType: 'xy',
                width: 2000, // Utiliser la largeur du conteneur parent
                height: 488 // Utiliser la hauteur du conteneur parent
              },
              credits: {
  ...
  return (
    <>
      ...
      <div className="h-[30rem] w-full flex justify-center items-center">
        <div className="h-[90%] w-[90%] bg-[green] shadow-sm flex justify-center items-center">
          <div className="h-[90%] w-[95%] bg-[orange]">
            <div ref={graphContainerRef}>
              <div id="container" style={{ width: '100%', height: '100%' }} />
              {/* Suppression de la section affichant le CSV */}
            </div>
          </div>
        </div>
      </div>
